...
//        music = arguments?.getSerializable("music") as Musics
//
//        return root
//    }
//
...
//            mediaPlayer?.start()
//            root.btn_pause.background = resources.getDrawable(R.drawable.pause_button)
...
//            }
//
//            root.txt_music_artist.text = MyData.list[position].avtor
//            root.txt_music_name.text = MyData.list[position].nomi
//
...
//            if (mediaPlayer?.isPlaying!!){
//                mediaPlayer?.pause()
//                root.btn_pause.background = resources.getDrawable(R.drawable.play)
//            }else{
//                mediaPlayer?.start()
//                root.btn_pause.background = resources.getDrawable(R.drawable.pause_button)
//            }
